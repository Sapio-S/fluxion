...
def singlemodel(params, i):
    ...
    created_model_name = all_lrn_asgmts['big_gp_model'].create_and_add_model(
        ...
        model_class_args=[
            (params['searchSpace']["hidden_size1"],params['searchSpace']["hidden_size2"],params['searchSpace']["hidden_size3"],params['searchSpace']["hidden_size4"],params['searchSpace']["hidden_size5"],params['searchSpace']["hidden_size6"]), 

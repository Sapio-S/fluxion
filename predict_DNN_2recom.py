...
dataset_filename2 = "dataset-recom-standardized.csv"
...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(10):
        f = open("log/1116/DNN_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for testing_sample_x, testing_sample_y_aggregation in zip(testing_samples_x, testing_samples_y_aggregation):
            ...
            big_DNN_abs_errs[-1].append(abs(pred - testing_sample_y_aggregation))
        
        # np.save("saved_model/DNN_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far),zoo.get_models_name())
        # zoo.dump("saved_model/DNN_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far))
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1116/DNN_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far), real_para)

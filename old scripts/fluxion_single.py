...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(num_experiments):
        f = open("log/1120/fluxion_single_"+str(num_training_data)+"_"+str(num_experiments),"w")
        sys.stdout = f
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1120/fluxion_single_"+str(num_training_data)+"_"+str(num_experiments), real_para)

...
dataset_filename3 = "dataset-scale-standardized.csv"
# inputs_name = expanded_sample_x_names
samples_x0, samples_y0, samples_y_aggregation0, err_msg0 = lib_data.readCSVFile([dataset_filename3], inputs_name+['recommendation_pod0:rps','recommendation_pod1:rps','checkout_pod0:rps','checkout_pod1:rps'], target_service_name)
...
for train_size in train_sizes:
    ...
    for num_experiments_so_far in range(10):
        f = open("log/1117/fluxion_2scale_"+str(train_size)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for sample_x, sample_y_aggregation in zip(samples_x0, samples_y_aggregation0):
            ...
            fluxion_input["recommendationservice:0.90"]["recommendationservice:0.90"][0]["recommendationservice:rps"] = sample_x[-4] # checkout_pod0
            fluxion_input["recommendationservice:0.90"]["recommendationservice:0.90"][1]["recommendationservice:rps"] = sample_x[-3] # checkout_pod0
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1117/fluxion_2scale_"+str(train_size)+"_"+str(num_experiments_so_far), real_para)

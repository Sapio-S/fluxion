...
for num_training_data in [10, 25, 50, 100, 150, 200, 300, 450, 550, 650, 800]:
    f = open("log/1024/DNN_"+str(num_training_data),"w")
    sys.stdout = f
    big_gp_abs_errs = []
    ...
    for num_experiments_so_far in range(num_experiments):
        ...
        numpy.save("saved_model/DNN_"+str(num_training_data)+"_"+str(num_experiments_so_far),zoo.get_models_name())
        zoo.dump("saved_model/DNN_"+str(num_training_data)+"_"+str(num_experiments_so_far))
    # for collection

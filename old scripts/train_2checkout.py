...
for train_size in train_sizes:
    ...
    for num_experiments_so_far in range(num_experiments):
        f = open("log/1116/fluxion_2checkout_"+str(train_size)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1116/fluxion_2checkout_"+str(train_size)+"_"+str(num_experiments_so_far), real_para)

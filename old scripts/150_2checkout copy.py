...
dataset_filename2 = "/home/yuqingxie/autosys/code/PlayGround/yuqingxie/dataset-150-checkout2-standardized.csv"
...
dataset_filename3 = "dataset-1204-standardized.csv"
...
for train_size in train_sizes:
    ...
    for num_experiments_so_far in range(num_experiments):
        f = open("log/1204_2/fluxion_2checkout_"+str(train_size)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1204_2/fluxion_2checkout_"+str(train_size)+"_"+str(num_experiments_so_far), real_para)

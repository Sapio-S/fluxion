...
dataset_filename = "/home/yuqingxie/autosys/code/PlayGround/yuqingxie/dataset-2checkout-mix-standardized.csv"
...
for num_training_data in train_size:
    f = open("log/1111/fluxion_2checkout-mix_test150_"+str(num_training_data),"w")
    sys.stdout = f
    small_models_preds = []
    ...
    for num_experiments_so_far in range(num_experiments):
        ...
        samples_x, samples_y, samples_y_aggregation, err_msg = lib_data.readCSVFile([dataset_filename2], inputs_name+['checkout_pod0:0.90','checkout_pod1:0.90'], "frontend:0.90")

...
all_sample_x_names={}
dataset_filename = "/home/yuqingxie/autosys/code/PlayGround/yuqingxie/dataset-150-mix1-standardized.csv"
...
dataset_filename2 = "dataset-150-mix1-standardized.csv"
...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(10):
        f = open("log/1128_2/GP_single_"+str(num_training_data)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1128_2/GP_single_"+str(num_training_data)+"_"+str(num_experiments_so_far), real_para)

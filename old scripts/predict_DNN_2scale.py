...
dataset_filename2 = "dataset-scale-standardized.csv"
...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(5,10):
        f = open("log/1030_2/DNN_2scale_"+str(num_training_data)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1030_2/DNN_2scale_"+str(num_training_data)+"_"+str(num_experiments_so_far), real_para)

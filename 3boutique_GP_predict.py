...
all_sample_x_names={}
dataset_filename = "/home/yuqingxie/autosys/code/PlayGround/yuqingxie/dataset-3-90-standardized.csv"
...
for service in all_sample_x_names.keys():
    ...
    expanded_sample_x_names.append(service[:-5]+"_pod2:rps")
...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(10):    
        f = open("log/1213/GP_3boutique_"+str(num_training_data)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f 
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1213/GP_3boutique_"+str(num_training_data)+"_"+str(num_experiments_so_far), real_para)

...
all_sample_x_names0['cartservice:0.90'] = ["cartservice:CPU_LIMIT", "cartservice:MEMORY_LIMIT", "cartservice:IPV4_RMEM", "cartservice:IPV4_WMEM", "cartservice:rps",
                                            "get:0.90", "set:0.90"]
# all_sample_x_names0['checkoutservice:0.90'] = ["checkoutservice:CPU_LIMIT", "checkoutservice:MEMORY_LIMIT", "checkoutservice:IPV4_RMEM", "checkoutservice:IPV4_WMEM", "checkout_pod0:rps",
#                                                 "emailservice:0.90", "paymentservice:0.90", "shippingservice:0.90", "currencyservice:0.90", "cartservice:0.90", "productcatalogservice:0.90"]
...
train_size = [150,200,300,400]
for num_training_data in train_size:
    f = open("log/1121/100_"+str(num_training_data),"w")
    sys.stdout = f
    small_models_preds = []
    ...
    for num_experiments_so_far in range(10):
        ...
        all_errs.append(np.mean([round(statistics.mean(errs), 8) for errs in fluxion_abs_errs]))

...
target_service_name = "frontend:0.95"  # "frontend:0.90", "frontend:0.95", "wrk|frontend|overall|lat-90", "wrk|frontend|overall|lat-95"
num_experiments = 10
...
def singlemodel(params, i):
    ...
    created_model_name = all_lrn_asgmts['big_gp_model'].create_and_add_model(
        training_samples_x, 
        training_samples_y_aggregation,  MultiLayerPerceptron, 
            model_class_args=[

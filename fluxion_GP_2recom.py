...
for num_training_data in train_size:
    ...
    for num_experiments_so_far in range(num_experiments):
        f = open("log/1116/GP_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far),"w")
        sys.stdout = f
        ...
        # np.save("saved_model/GP_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far),zoo.get_models_name())
        # zoo.dump("saved_model/GP_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far))
        ...
        for k in inputs_name:
            ...
            cnt += 1
        print(real_para)
        np.save("log/1116/GP_2recom_"+str(num_training_data)+"_"+str(num_experiments_so_far), real_para)
